...
#SBATCH --job-name=part1_unified_no_outage
...
#SBATCH --mem=192G
#SBATCH --array=0-5
#SBATCH -o logs/part1_unified_no_outage_lag-%A_%a.out
#SBATCH -e logs/part1_unified_no_outage_lag-%A_%a.err
...
FEATURE_SET_MODE="no_outage_lag"
WEATHER_SOURCE_MODE="${WEATHER_SOURCE_MODE:-lagged_observed}"
EXTRA_FLAGS="${EXTRA_FLAGS:-}"

# Local scratch for heavy I/O
LOCAL_RUN_DIR="${SLURM_TMPDIR:-/tmp}/myproj_${SLURM_JOB_ID:-nojid}_${SLURM_ARRAY_TASK_ID:-noidx}_no_outage_lag"
...
# LOGGING SETUP
# ============================================================================
LOGFILE="${LOCAL_LOGS}/training_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID}_no_outage_lag.log"
...
# JOB CONFIGURATION
# ============================================================================
declare -a MODEL_TYPES=("Unified" "Unified" "Unified" "Unified" "Unified" "Unified")
...
echo "NOTE: Unified trains one model across event types."
